...
export class AuthService {
  ...
  // postchat2(message: string, input_language: string, output_language: string): Observable<any> {
  //   const url = `${environment.apii}chat-basic/`;
  //   const body = { message, input_language, output_language };
  ...
  postchat(formData: any): Observable<any> {
    return this.http.post(environment.apii + 'translate-chams/', formData) as Observable<any[]>;
  }
}
